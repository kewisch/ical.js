...
ICAL.Todo = (function() {
  ...
  Todo.prototype = {
     ...
     * exceptions related to it.
     *
     * @param {ICAL.Component|ICAL.Todo} obj component or event.
     */
    relateException: function(obj) {
      if (this.isRecurrenceException()) {
        throw new Error('cannot relate exception to exceptions');
     ...
     *
     * @param {ICAL.Time} time usually an occurrence time of an event.
     * @return {ICAL.Todo|Null} the related event/exception or null.
     */
    findRangeException: function(time) {
      if (!this.rangeExceptions.length) {
        return null;
    ...
    get categories() {
      return this._firstProp('categories');
    },

    set categories(value) {
      return this._setProp('categories', value);
    },

    get class() {
      return this._firstProp('class');
    },

    set class(value) {
      return this._setProp('class', value);
    },
    ...
    get transp() {
      return this._firstProp('transp');
    },

    set transp(value) {
      this._setProp('transp', value);
    },
...
ICAL.ComponentParser = (function() {
  ...
  ComponentParser.prototype = {
     ...
     */
    ontodo: /* istanbul ignore next */ function(component) {},
