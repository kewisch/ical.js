...
ICAL.design = (function() {
  ...
  var DEFAULT_TYPE_BOOLEAN = { defaultType: "boolean" };
...
ICAL.Event = (function() {
  ...
  Event.prototype = {
    ...
    get allday() {
      return this._firstProp('allday');
    },

    set allday(value) {
      return this._setProp('allday', value);
    },
...
ICAL.Todo = (function() {
  ...
  function Todo(component, options) {
    if (!(component instanceof ICAL.Component)) {
      options = component;
      component = null;
    }
    ...
    if (component) {
      ...
      this.component = new ICAL.Component('vtodo');
    }
  ...
  Todo.prototype = {
    ...
    /**
     * List of related Todo exceptions.
     *
     * @type Array[ICAL.Todo]
     */
    exceptions: null,
    ...
    /**
     * Relates a given Todo exception to this object.
     * If the given component does not share the UID of
     * this Todo it cannot be related and will throw an
     * exception.
     *
     * If this component is an exception it cannot have other
     * exceptions related to it.
     *
     * @param {ICAL.Component|ICAL.Todo} obj component or todo.
     */
    relateException: function(obj) {
      if (this.isRecurrenceException()) {
        throw new Error('cannot relate exception to exceptions');
     ...
     * Finds the range exception nearest to the given date.
     *
     * @param {ICAL.Time} time usually an occurrence time of an Todo.
     * @return {ICAL.Todo|Null} the related Todo/exception or null.
     */
    findRangeException: function(time) {
      if (!this.rangeExceptions.length) {
        return null;
    ...
    /**
     * Returns the types of recurrences this todo may have.
     *
     * Returned as an object with the following possible keys:
     *
     *    - YEARLY
...
ICAL.ComponentParser = (function() {
  ...
  ComponentParser.prototype = {
    ...
    /*
     * Fired when a top level component (VTODO) is found.
     * @param {ICAL.Todo} component top level component.
     */
    ontodo: function(component) {},
    ...
    process: function(ical) {
      ...
      for (; i < len; i++) {
        ...
        switch (component.name) {
          ...
          case 'vtodo':
            if (this.parseTodo) {
              this.ontodo(new ICAL.Todo(component));
            }
          break;
          default:
            continue;
