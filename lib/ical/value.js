...
(function() {
  ICAL.Value = function icalvalue(aData, aParent, aType) {
    this.parent = aParent;
    this.fromData(aData, aType);
  };

  ICAL.Value.prototype = {
  ...
  ICAL.Value.fromString = function icalvalue_fromString(aString, aType) {
    var val = new ICAL.Value();
    val.fromString(aString, aType);
    return val;
  };

  ICAL.Value._createFromString = function icalvalue__createFromString(ctor) {
  ...
  ICAL.Binary = function icalbinary(aData, aParent) {
    ICAL.Value.call(this, aData, aParent, "binary");
  };

  ICAL.Binary.prototype = {

    __proto__: ICAL.Value.prototype,
  ...
  ICAL.Value._createFromString(ICAL.Binary);

  ICAL.UtcOffset = function icalutcoffset(aData, aParent) {
    ICAL.Value.call(this, aData, aParent, "utc-offset");
  };

  ICAL.UtcOffset.prototype = {
  ...
  ICAL.Value._createFromString(ICAL.UtcOffset);
})();
