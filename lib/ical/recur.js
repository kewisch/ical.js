...
(function() {
  ...
  icalrecur_iterator.prototype = {
    ...
    _byDayAndMonthDay: function(isInit) {
      ...
      var byMonthDay = this.by_data.BYMONTHDAY;
      var byDay = this.by_data.BYDAY;

      var date;
      var dateIdx = 0;
      var dateLen = byMonthDay.length;
      var dayIdx = 0;
      ...
      function initMonth() {
        daysInMonth = ICAL.icaltime.days_in_month(
      ...
      // while we don't have valid date and we still have dates
      // to iterate over...
      while (!data_valid) {
        // find next date
