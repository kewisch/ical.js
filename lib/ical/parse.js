ICAL.parse = (function() {
  ...
  parser._handleContentLine = function(line, state) {
    ...
    /*if (valuePos !== -1 && paramPos > valuePos ) {
      paramPos = -1;
    }*/
    ...
    if (paramPos !== -1) {
      ...
      lastParamIndex = parsedValue.length + parsedParams[2];
  ...
  parser._parseParameters = function(line, start) {
    ...
    while ((pos !== false) &&
      ...
      //var substrOffset = -2;
      var temp = helpers.unescapedIndexOf(line, PARAM_DELIMITER, pos+1);
      if (nextChar === '"') {
        //var oldval = ;
        var valuePos = pos + 2;
        ...
        // move to next ";"
        var nextPos = temp;//helpers.unescapedIndexOf(line, PARAM_DELIMITER, valuePos);
