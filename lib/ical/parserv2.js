  ...
  parser.handleContentLine = function(line, state) {
    ...
    if (value) {
      if (multiValue) {
        ...
        // hook for GEO mostly so we don't
        // need to special case it here.
        // Any importICAL function that returns an
        // array with be used as the basis for the results.
        // So the format will always be ['name', {}, type, value, value...]
