...
(function() {
  ...
  ICAL.icaltime.prototype = {
    ...
    /**
     * Finds the nthWeekDay relative to the current day.
     ...
     */
    nthWeekDay: function icaltime_nthWeekDay(aDayOfWeek, aPos, givenStart) {
      var daysInMonth = ICAL.icaltime.days_in_month(this.month, this.year);
      var weekday;
      var pos = aPos;

      // starting position only useful
      ...
      if (pos >= 0) {
        ...
        // copy of this day
        var lastDay = this.clone();

        // then we set it to the last day in the current month
        lastDay.day = daysInMonth;

        // find the ends weekday
        var endDow = lastDay.dayOfWeek();
      ...
      if (typeof(givenStart) !== 'undefined') {
        start = givenStart;
      }
    ...
    isNthWeekDay: function(aDayOfWeek, aPos) {
      ...
      // get pos
      var day = this.nthWeekDay(aDayOfWeek, aPos, 0);
