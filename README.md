...
[tools/](https://github.com/mozilla-comm/ical.js/tree/main/tools) subdirectory.

[Try the validator online](http://mozilla-comm.github.io/ical.js/validator.html), it always uses the latest release of ICAL.js.
...
See [the wiki](https://github.com/mozilla-comm/ical.js/wiki/Running-Tests) for more details.

Code coverage is automatically generated for the node unit tests. You can [view the coverage
results](https://coveralls.io/r/mozilla-comm/ical.js) online, or run them locally to make sure new
code is covered.
